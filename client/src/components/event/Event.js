    ...
    return (
        <div className="sm:ml-80 py-20 md:px-28 px-6 flex flex-col space-y-12 text-secondary sm:w-3/4">
            ...
            {posts.length === 0 ? (
                ...
                posts.map(post => (
                    <div key={post.id} className="flex 2xl:flex-row flex-col border-primary border-b border-t py-5 justify-center ">
                        <div className="flex flex-col items-center justify-center sm:pt-0 pt-4 sm:space-y-0 space-y-4 pb-4">
                            <div className="xl:w-[34rem] xl:h-[34rem]  overflow-hidden">
                                {post.image_url ? (
                                    <img src={post.image_url} alt="Event" className="w-full h-full object-cover border border-secondary  transition-transform duration-200 hover:scale-125" />
                                ) : (
                                    <p className="text-white">No image available</p>
                                )}
                            </div>
                        </div>
                        <div className="flex flex-col justify-between  ml-4 2xl:ml-12 sm:pt-0  2xl:space-y-0 space-y-4">
                            ...
                            <p className="text-xs md:text-base italic md:ml-36 2xl:ml-0">
